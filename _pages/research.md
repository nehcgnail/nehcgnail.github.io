...
We found that the narrative data of reports (e.g., event description in free text) carry valuable information (e.g., interconnected procedures, shared responsibilities, contributing factors, etc.) that may disclose vulnerabilities of the health system. However, the traditional RCA is time consuming. Inspired by psycholinguistic studies, semantic web ontology, and machine learning, we developed methods to facilitate the RCA. 
Funding: NIH and the University of Texas System (PI: Yang Gong, MD, PhD, UTHealth)
